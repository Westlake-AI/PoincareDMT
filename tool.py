...
class AutoTrainer():
    ...
    def Run(self, ):
        ...
        for i, item in enumerate(self.loopList):
            ...
            txt_proxy = "HTTPS_PROXY=http://10.18.155.13:7890"
            ...
            txt = ' '.join([txt_proxy, txtDevice, txtmain, txtparam, txtname])
            txtp = ' '.join([txt_proxy, txtDevice, 'nohup', txtmain, txtparam, txtname])
            txtp = ' '.join([txt_proxy, txtDevice, txtmain, txtparam, txtname])
