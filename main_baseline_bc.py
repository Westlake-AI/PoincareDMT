...
import wandb
from eval.eval_xu import Eval_all, Eval_all_sample, Eval_all_poincaremaps, Eval_all_sample_poincaremaps
...
if __name__ == "__main__":
    ...
    wandb.init(
        name=runname,
        project="sc_lineage_forceatlas_update" + args.project_name,
    ...
    from eval.eval_xu_bc import Eval_all_structure_all
    ...
    wandb.log(
            {
                'metric/Q_local':result_index_local[0][1],
                'metric/Q_global':result_index_global[0][1],
                'metric/acc_mean':acc_mean,
                'metric/silhouette_mean':silhouette_mean,
            }
        )